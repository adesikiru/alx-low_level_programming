...
chmod u+x 2-O && git add --chmod=+x 2-O && git commit -m 'Task 02 a function that searches for a value in a sorted array of integers using the Binary search algorithm 2-O' && git push
