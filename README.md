...
chmod u+x 100-jump.c && git add --chmod=+x 100-jump.c && git commit -m 'Advanced task 100 a program that displays the information contained in the ELF header at the start of an ELF file. 100-jump.c' && git push
