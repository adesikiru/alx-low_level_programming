...
chmod u+x 102-interpolation.c && git add --chmod=+x 102-interpolation.c && git commit -m 'Advanced task 107 a function that searches for a value in a sorted array of integers using the Interpolation search algorithm 102-interpolation.c' && git push
