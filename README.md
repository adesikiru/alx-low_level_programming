...
chmod u+x 101-O && git add --chmod=+x 101-O && git commit -m 'Advanced task 101 a function that searches for a value in a sorted array of integers using the Jump search algorithm 101-O' && git push
